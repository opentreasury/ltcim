                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                ...
                                <p>
                                    Add the class
                                    <strong>.table--alternate-column</strong> to the table element to offset every second column with a slightly darker background colour. This is useful when creating wide tables with many values.
                                </p>
                                <pre>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                ...
                                <p>
                                    Add the class
                                    <strong>.table--alternate-row</strong> to the table element to offset every second row with a slightly darker background colour. This is useful when creating wide tables with many values.
                                </p>
                                <pre>
