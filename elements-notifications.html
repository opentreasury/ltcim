                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                ...
                                <p>
                                    Notifications can be triggered by any element on the page that shares the same
                                    <strong>data-notification-link</strong> with the corresponding
                                ...
                                <ul class="bullets">
                                    <li>
                                        <strong>.pos-left,right,top,bottom</strong> - positions the notification on the page</li>
                                    <li>
                                        <strong>[data-animation="from-left,right,top,bottom"]</strong> - determines the direction the notification should pop in from</li>
                                    <li>
                                        <strong>.col-*</strong> - Use the
                                        <a href="elements-grid.html">grid</a> classes to determine the width of the notification</li>
                                </ul>
                                <pre>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="notification pos-right pos-bottom col-md-4 col-lg-3" data-animation="from-bottom" data-notification-link="trigger">
                                <div class="boxed boxed--border border--round box-shadow">
                                    <img alt="avatar" class="image--sm" src="img/avatar-round-1.png" />
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                ...
                                <p>
                                    You can adjust the autoshow time by adding the data attribute
                                    <strong>data-autoshow=""</strong> to the
                                    <strong>.notification</strong> element with a millisecond value ie. a value of '1000' would show the notification 1 second after the page has loaded.
                                </p>
                                <pre>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                <h4>Autohide Notification</h4>
                                <p>
                                    In addition to triggering and autoshowing a notification, you can easily set a notification to automatically hide itself after a specific time in milliseconds using the
                                    <strong>data-autohide</strong> attribute.
                                </p>
                                <pre>
...
&lt;/div&gt;&lt;!--end of notification--&gt;
                        ...
                        <div class="col-md-4">
                            <a class="btn" href="#" data-notification-link="autohide-trigger">
                                <span class="btn__text">
                                    Trigger Autohide Notification
                                </span>
                            </a>
                            <div class="notification pos-right pos-bottom col-md-4 col-lg-3" data-animation="from-bottom" data-notification-link="autohide-trigger" data-autohide="2000">
                                <div class="boxed boxed--border border--round box-shadow">
                                    <img alt="avatar" class="image--sm" src="img/avatar-round-1.png" />
                                    <div class="text-block">
                                        <h5>Well Triggered!</h5>
