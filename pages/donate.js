            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src="/img/rukesh-patel.jpeg"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Rukesh Patel</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Advisory Board
                    </p>
                  </div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src="/img/lira-priyadarsani.jpeg"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Lira Priyadarsani</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Advisory Board
                    </p>
                  </div>
              ...
              <div className="mt-5 w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src="/img/dinesh-singh.jpg"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Dinesh Singh</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Steering Board
                    </p>
                  </div>
              ...
              <div className="mt-5 w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src="/img/audrey-ndum.jpg"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Audrey Ndum</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Fellowship Grantee
                    </p>
                  </div>
              ...
              <div className="mt-5 w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src="/img/johnson-chetty.jpg"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Johnson Chetty</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Systems Architect
                    </p>
                  </div>
